...
0. Run `review-tf-design` agent as subagent - Review and approve Terraform design
...
12. Record Github branch and issue details to ./specs/<FEATURE_NAME>/gh-issue.json for use by implementation agent
