...
13. Update Git issue with user detailis and approval status.
14. Ensure that `specs/{FEATURE}/gh-issue.json` contains all necessary details for implementation agent to proceed.
